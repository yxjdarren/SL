...
# training/test_single_agent
def get_single_agent_cifar100(num_tasks, batch_size, subtask_classes_num, num_imgs_per_cate, path):
    dataloader_train = {}
    dataloader_test = {}

    # for i in range(num_tasks):
    i = num_tasks
    task_folder_path = os.path.join(path, 'Task_' + str(i), 'traindata_' + str(i))
    ...
    # for i in range(num_tasks):
    i = num_tasks
    task_folder_path = os.path.join(path, 'Task_' + str(i), 'testdata_' + str(i))
...
def get_multi_agent_cifar100(num_tasks, batch_size, subtask_classes_num, num_imgs_per_cate, path):
    dataloader_train = {}
    dataloader_test = {}
    ...
    i = num_tasks
    task_folder_path = os.path.join(path, 'Task_' + str(i), 'traindata_' + str(i))
    print("Dataset:", task_folder_path)
